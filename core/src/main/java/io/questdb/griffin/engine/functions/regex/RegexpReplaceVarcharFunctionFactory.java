...
public class RegexpReplaceVarcharFunctionFactory extends RegexpReplaceStrFunctionFactory {
    ...
    private static class SingleGroupAsciiFunc extends VarcharFunction implements UnaryFunction {
        ...
        public Function deepClone() {
            ...
            return new SingleGroupAsciiFunc(value.deepClone(), matcher, replacement, group, functionPos, pattern);
        }
    ...
    private static class SingleGroupFunc extends StrFunction implements UnaryFunction {
        ...
        public Function deepClone() {
            CharSequence regex = pattern.getStrA(null);
            Matcher matcher = Pattern.compile(Chars.toString(regex)).matcher("");
            return new SingleGroupFunc(value.deepClone(), matcher, replacement, group, functionPos, pattern);
        }
